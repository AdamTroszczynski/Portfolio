<template>
  <div
    class="bg-priary-white shadow-base-lg flex max-w-[356px] flex-col overflow-hidden rounded-xl lg:max-w-[382px]"
  >
    <img
      :src="imgSrc"
      alt="test"
      class="min-h-[160px] lg:max-h-[192px] lg:min-h-[192px]"
      :class="isMobile ? 'object-contain' : 'object-cover'"
    />
    <div class="flex flex-col gap-[12px] p-[20px] lg:gap-[14px] lg:p-[24px]">
      <h3 class="d-header-xs text-primary-black lg:d-header-sm">
        {{ header }}
      </h3>
      ...
      <div class="flex gap-[12px] lg:gap-[12px]">
        <BaseButton :bg-color="buttonColor" icon="goto">
          View Details
        </BaseButton>
